                                        ...
                                        <form className="from-horizontal" method="post">
                                            <fieldset>
                                                ...
                                                <div className="form-group">
                                                    <span className="col-md-offset-2 text-center"><i className="fa fa-user bigicon"></i></span>
                                                ...
                                                <div className="form-group">
                                                    <span className="col-md-offset-2 text-center"><i className="fa fa-pencil-square-o bigicon"></i></span>
                                                    <textarea onChange={this.onChange('content')} name="content" type="text" placeholder="Enter Your text" className="form-control" rows="7"></textarea>
                                                </div>
                                                <div className="form-group">
